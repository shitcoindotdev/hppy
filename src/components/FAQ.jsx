		...
		<div className="flex w-full flex-col gap-4 tracking-tighter md:max-w-[800px]">
					...
					<details className="group peer">
						<summary className="flex cursor-pointer items-center gap-2 px-4 py-2">
							<h2 className="text-left font-semibold">
								2. Buy $BUNNY with <span className="text-[#ab9ff2]">Phantom</span>
							</h2>
						</summary>
					</details>
					<div className="grid grid-rows-[0fr] transition-[grid-template-rows] duration-[250ms] ease-in-out peer-open:grid-rows-[1fr]">
						<div className="overflow-hidden">
							<div className="group-open:border-t-1 white mx-4 flex -translate-y-3 flex-col gap-4 border-t border-white py-3 text-left transition-all duration-[250ms] ease-in-out">
								<p>
									...
									paste the $BUNNY Contract Address in the search bar:
								</p>
								<p className="text-[12px] text-green-500">tokenaddress</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div className="rounded-xl bg-black/25 text-white">
				<div>
					<details className="group peer">
						<summary className="flex cursor-pointer items-center gap-2 px-4 py-2">
							<h2 className="text-left font-semibold">3. Swap SOL for $BUNNY</h2>
						</summary>
					</details>
					<div className="grid grid-rows-[0fr] transition-[grid-template-rows] duration-[250ms] ease-in-out peer-open:grid-rows-[1fr]">
						<div className="overflow-hidden">
							<div className="group-open:border-t-1 white mx-4 flex -translate-y-3 flex-col gap-4 border-t border-white py-3 text-left transition-all duration-[250ms] ease-in-out">
								<p>
									Enter any amount of SOL you want to Swap into $BUNNY and confirm the the Swap in
									the&nbsp;
