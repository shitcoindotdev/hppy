	...
	return (
        ...
        <a target="_blank" href="">
          <Image
			...
			<li>
				<a target="_blank" href="https://t.me/oghoppysol">
					<Image
						className="h-[77px] w-[auto]"
			...
			<li className="flex h-[77px] w-[77px] items-center justify-center rounded-full bg-black">
				<a target="_blank" href="https://dexscreener.com/solana/ffaoneyajfqzvb2a9mef3dx5bwvu1cxshj4fi1cg9arq">
					<svg
			...
			<li>
				<a
					target="_blank"
					href="https://www.dextools.io/app/en/solana/pair-explorer/FFAoNeyAJfqzVb2a9MEF3Dx5bWvU1cxsHj4fi1cg9arQ?t=1719924485384"
				>
					<Image
						className="h-[77px] w-auto"
